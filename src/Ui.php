...
final class Ui
{
    ...
    public static function toast(string $title, ?string $message = null, string $tone = 'info', int $timeout = 3500, array $attributes = []): Toast
    {
        return new Toast($title, $message, $tone, $timeout, $attributes);
    }

    public static function toaster(array $toasts = [], string $position = 'top-center', array $attributes = []): Toaster
    {
        return new Toaster($toasts, $position, $attributes);
    }

    public static function flashToaster(array $flash, string $position = 'top-center', array $attributes = []): Toaster
    {
        return Toaster::fromFlash($flash, $position, $attributes);
    }
