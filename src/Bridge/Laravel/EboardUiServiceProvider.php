    ...
    final class EboardUiServiceProvider extends ServiceProvider
    {
        public function boot(): void
        {
            $this->publishes([
                ...
                dirname(__DIR__, 3).'/resources/css/filter-form.css' => public_path('vendor/eboard-ui/filter-form.css'),
                dirname(__DIR__, 3).'/resources/css/toast.css' => public_path('vendor/eboard-ui/toast.css'),
